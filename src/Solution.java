...
//        •	В классах Hrivna, Ruble и USD должен быть реализован публичный конструктор с одним параметром типа double, который устанавливает значение поля amount класса Money путем вызова конструктора класса родителя c тем же параметром.
import java.util.*;
...
public class Solution {
    ...
    static class Person {
        ...
        Person(String name) {
            ...
            allMoney.add(new USD(213.34));
            allMoney.add(new Ruble(33.43));
            allMoney.add(new Hrivna(34.2));
        }
